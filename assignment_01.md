...
#### Кандидат 1 (основной): **Mask R-CNN**

**Преимущества:**

* высокая точность локализации дефектов сложной формы;
...
#### Кандидат 2 (альтернатива): **YOLO-Seg / RTMDet-Ins**

**Преимущества:** высокий throughput, проще масштабировать.
...
Для дальнейшего проектирования выбрана **Mask R-CNN** как наиболее подходящая модель для промышленного контроля качества с требованиями к точной локализации дефектов.
